package org.edible_crystals_mod.block.entity.renderer;
...
public class CrystalInfusionTableRenderer implements BlockEntityRenderer<CrystalInfusionTableEntity> {
    ...
    @Override
    public void render(CrystalInfusionTableEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
